...
{
    return new Book(prodName_, price_, qty_, isbn_, author_); // book DONE
}
...
{
    return new Clothing(prodName_, price_, qty_, size_, brand_); // clothing DONE
}
...
{
    return new Movie(prodName_, price_, qty_, genre_, rating_); // movie DONE
}
